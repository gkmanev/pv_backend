...
"""
Django settings for pv_backend project.
...
ALLOWED_HOSTS = ['localhost','127.0.0.1','85.14.6.37', '209.38.208.230']
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 6000,  # Customize this based on your needs
}
...
WSGI_APPLICATION = 'pv_backend.wsgi.application'
